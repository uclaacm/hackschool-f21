...
- [Hackschool Session 3: Introduction to React](#hackschool-session-3-introduction-to-react)
  - [Resources](#resources)
  - [What we'll be learning today](#what-well-be-learning-today)
  - [Arrays](#arrays)
    - [Array Syntax](#array-syntax)
    - [Array Indexing](#array-indexing)
    - [Arrays: Useful Operations](#arrays-useful-operations)
    - [Looping through Arrays](#looping-through-arrays)
    - [Advanced Array Stuff: _array.map()_](#advanced-array-stuff-arraymap)
      - [Why do we use _array.map()_?](#why-do-we-use-arraymap)
  - [Props](#props)
    - [Recap of last session](#recap-of-last-session)
    - [Demo](#demo)
    - [🚩 Checkpoint : Game 1](#-checkpoint--game-1)
    - [Breaking down the Netflix Episode List](#breaking-down-the-netflix-episode-list)
    - [🚩 Checkpoint : Game 2](#-checkpoint--game-2)
    - [Breaking down the Netflix Episode Component](#breaking-down-the-netflix-episode-component)
    - [🚩 Checkpoint : Game 3](#-checkpoint--game-3)
    - [What is Props?](#what-is-props)
      - [An Analogy: Functions](#an-analogy-functions)
      - [You've seen Props being used before](#youve-seen-props-being-used-before)
    - [How to define Props](#how-to-define-props)
    - [Applying this to our EpisodeList](#applying-this-to-our-episodelist)
    - [🚩 Checkpoint : Game 4](#-checkpoint--game-4)
    - [Using `Array.map()`](#using-arraymap)
    - [🚩 Checkpoint : Game 5](#-checkpoint--game-5)
  - [Layout](#layout)
    ...
    - [Practice](#practice)
    - [Applying Flex Box to Netflix](#applying-flex-box-to-netflix)
